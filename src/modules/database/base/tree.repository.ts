...
import { OrderType, TreeChildrenResolve } from '../constant';
...
export class BaseTreeRepository<E extends ObjectLiteral> extends TreeRepository<E> {
     ...
     * @param options
     */
    override async findTrees(options?: FindTreeOptions & QueryParams<E>) {
     ...
     * @param options
     */
    override async findRoots(options?: FindTreeOptions & QueryParams<E>) {
     ...
     * @param options
     */
    override async findDescendantsTree(entity: E, options?: FindTreeOptions & QueryParams<E>) {
        const { addQuery, orderBy, withTrashed, onlyTrashed } = options ?? {};
     ...
     * @param options
     */
    override async findAncestorsTree(entity: E, options?: FindTreeOptions & QueryParams<E>) {
        const { addQuery, orderBy, withTrashed, onlyTrashed } = options ?? {};
        let qb = this.buildBaseQB(
            this.createDescendantsQueryBuilder(this.qbName, 'treeClosure', entity),
        );
     ...
     * @param options
     */
    override async findDescendants(entity: E, options?: FindTreeOptions & QueryParams<E>) {
        const { addQuery, orderBy, withTrashed, onlyTrashed } = options ?? {};
        let qb = this.buildBaseQB(
            this.createDescendantsQueryBuilder(this.qbName, 'treeClosure', entity),
        );
     ...
     * @param options
     */
    override async findAncestors(entity: E, options?: FindTreeOptions & QueryParams<E>) {
        const { addQuery, orderBy, withTrashed, onlyTrashed } = options ?? {};
        let qb = this.buildBaseQB(
     ...
     * @param options
     */
    override async countDescendants(entity: E, options?: FindTreeOptions & QueryParams<E>) {
        const { addQuery, orderBy, withTrashed, onlyTrashed } = options ?? {};
     ...
     * @param options
     */
    override async countAncestors(entity: E, options?: FindTreeOptions & QueryParams<E>) {
        const { addQuery, orderBy, withTrashed, onlyTrashed } = options ?? {};
